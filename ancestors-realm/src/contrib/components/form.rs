//! ## Form
//!
//! `Form` represents a read-write input field. This component supports different input types, input length
...
pub struct FormStates {
    ...
    pub cursor: usize,    // Form position
}
...
mod tests {
    ...
    fn test_components_input_states() {
        let mut states: FormStates = FormStates::default();
    ...
    fn test_components_input_text() {
        // Instantiate Form with value
        let mut component: Form = Form::default()
