...
type KeyBindingsType = HashMap<Mode, HashMap<Vec<KeyEvent>, Action>>;

#[derive(Clone, Debug, Default)]
pub struct KeyBindings(pub KeyBindingsType);

impl core::ops::Deref for KeyBindings {
    type Target = KeyBindingsType;
...
impl core::ops::DerefMut for KeyBindings {
...
type StylesType = HashMap<Mode, HashMap<String, Style>>;
#[derive(Clone, Debug, Default)]
pub struct Styles(pub StylesType);

impl core::ops::Deref for Styles {
    type Target = StylesType;
...
impl core::ops::DerefMut for Styles {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
