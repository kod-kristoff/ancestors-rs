...
impl Default for MainView {
    ...
    fn default() -> Self {
        ...
        view.login_input
            .set_normal_style(CompoundStyle::with_fgbg(gray(22), gray(2)));
        view.password_input
            .set_normal_style(CompoundStyle::with_fgbg(gray(22), gray(2)));
        view.comments_input
            .set_normal_style(CompoundStyle::with_fgbg(gray(22), gray(2)));
...
impl MainView {
    ...
    pub fn resize(&mut self, area: Area) -> bool {
        ...
        if self.drawable {
            ...
            self.password_input
                .change_area(half_width + 2, y, half_width);
            let y = y + 2;
            let h = area.height - 1 - h;
            self.comments_label_area = Area::new(1, y, half_width, h);
            self.comments_input.set_area(Area::new(
                half_width + 2,
                y,
                half_width,
                area.height - y - 1,
    ...
    pub fn apply_mouse_event(&mut self, mouse_event: MouseEvent, double_click: bool) -> bool {
        if self
            .login_input
            .apply_mouse_event(mouse_event, double_click)
        {
    ...
    pub fn queue_on<W: Write>(&mut self, w: &mut W) -> eyre::Result<()> {
